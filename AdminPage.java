...
public class AdminPage extends javax.swing.JFrame {
    ...
    public static void getAdminPage(String admin) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    static void setBookings2(int BookingID) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    public AdminPage() {
        ...
        Server getBookings = new Server();
        
        
        
        for (int j = 0; j<q; j++){
            
            jTable3.setValueAt(test[j][0], j, 0);
            jTable3.setValueAt(test[j][1], j, 1);
            jTable3.setValueAt(test[j][2], j, 2);
            jTable3.setValueAt(test[j][3], j, 3);
    ...
    static void setBookings(String BookingID,String BookingDate, String ConcertDesc, String Price){
        String[] Bookings1 = {BookingID, BookingDate, ConcertDesc, Price };
            test[q][0] = Bookings1[0];
            test[q][1] = Bookings1[1];
            test[q][2] = Bookings1[2];
            test[q][3] = Bookings1[3];
    ...
    private void initComponents() {
        ...
        jTable3.setGridColor(new java.awt.Color(214, 213, 213));
        ...
        jTable3.getColumn("Id").setPreferredWidth(30);
        jTable3.getColumn("Date").setPreferredWidth(70);
        jTable3.getColumn("Show").setPreferredWidth(400);
        jTable3.getColumn("Price").setPreferredWidth(100);

        DefaultTableModel model = (DefaultTableModel) jTable3.getModel();

        deleteButton.setBackground(new java.awt.Color(21, 97, 255));
        ...
        jTabbedPane1.addTab("Edit Bookings", jPanel3);
    ...
    private void deleteButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteButtonMouseClicked
        int dialogDelete=JOptionPane.showConfirmDialog(null,"Are you sure you want to delete this Booking?", "DELETE BOOKING",JOptionPane.YES_NO_OPTION);
        ...
        try (Connection conn = DriverManager.getConnection(url,dbUser,dbPass)) {
            ...
            String selectedRow = model.getValueAt(row, 0).toString();
            
            if (row >= 0) 

            model.removeRow(row);

            String query = "delete from bookings WHERE BookingID="+selectedRow+"";
